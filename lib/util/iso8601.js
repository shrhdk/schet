...
var normalize = function (str, offset = 0) {
...
var simplifyDateRange = function (str) {
...
var simplifyDateTimeRange = function (str, offset = 0) {
...
var simplify = function (str, offset = 0) {
  if (isDate(str)) {
